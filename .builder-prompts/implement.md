...
Project directory: /tmp/crazytrends-care-cart

Task metadata:
- Asana task gid: 1216852603162080
- Asana task name: GB GW4 C972
- Asana URL: https://app.asana.com/1/1208304498069546/project/1213586227413017/task/1216852603162080
- App name: Crazytrends Care Cart
- Company: CRAZYTRENDSUK-1 LTD
- Domain: https://crazytrends-uk.shop
- Package: crazytrendsuk1.cosmetics.crazytrendscarecart
- Prefix: MZFCM
- Type: shop
- Description: Специфика компании - торговля косметическими и уходовыми товарами. Приложение по продаже товаров компании, содержит список всех товаров компании (если разных категорий - с возможностью сортировки по категориям). История покупок. Корзина товаров с формой бронирования заказа. После подтверждения бронирования пользователь видит баннер с информацией о номере и деталях заказа с уведомлением о том, что его ожидают в магазине в течении 24 часов. Настройки должны содержать информацию о: названии компании, версии приложения, линку Customers Support со ссылкой сайт компании.
(можно разнообразить главную страницу каруселью с заметками или статьями по косметике и уходу за собой)

Do Phase 2 and Phase 3 only:
1. Extract or derive the style guide.
2. Do not create project-local agent instruction files inside /tmp/crazytrends-care-cart.
