Generate and install the app icon for /tmp/crazytrends-care-cart.
...
/tmp/crazytrends-care-cart/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/crazytrends-care-cart/app/src/main/res/drawable/icon.png`.
