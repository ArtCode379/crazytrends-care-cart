...
import crazytrendsuk1.cosmetics.crazytrendscarecart.di.dataModule
import crazytrendsuk1.cosmetics.crazytrendscarecart.di.dispatcherModule
import crazytrendsuk1.cosmetics.crazytrendscarecart.di.viewModule
...
class MZFCMApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@MZFCMApplication)
            modules(appModules)
        }
