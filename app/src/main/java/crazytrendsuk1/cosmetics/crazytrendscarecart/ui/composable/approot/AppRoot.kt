package crazytrendsuk1.cosmetics.crazytrendscarecart.ui.composable.approot
...
import crazytrendsuk1.cosmetics.crazytrendscarecart.ui.composable.navigation.AppNavHost
import crazytrendsuk1.cosmetics.crazytrendscarecart.ui.composable.navigation.NavRoute
...
private val navigationItems: List<BottomNavItem> = listOf(
    BottomNavItem(
        titleRes = R.string.mzfcm_bottom_bar_nav_item_home_title,
        icon = Icons.Default.Home,
        route = NavRoute.Home,
    ),
    BottomNavItem(
        titleRes = R.string.mzfcm_bottom_bar_nav_item_cart_title,
        icon = Icons.Default.ShoppingCart,
        route = NavRoute.Cart,
    ),
    BottomNavItem(
        titleRes = R.string.mzfcm_bottom_bar_nav_item_orders_title,
        icon = Icons.Default.CalendarToday,
        route = NavRoute.Orders,
    ),
    BottomNavItem(
        titleRes = R.string.mzfcm_bottom_bar_nav_item_settings_title,
